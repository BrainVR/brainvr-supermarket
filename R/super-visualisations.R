...
#'
#' @examples
plot_supermarket_path <- function(obj, background = FALSE, background_type = "categories", custom_background = NULL, ...){
  g <- ggplot() + geom_navr_limits(obj) ## this is just to set the generic
  if(background){
